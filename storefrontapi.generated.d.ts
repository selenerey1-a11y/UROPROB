...
export type OtherProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type ProductPageBlogArticlesQueryVariables = StorefrontAPI.Exact<{
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ProductPageBlogArticlesQuery = {
  blogs: {
    nodes: Array<
      Pick<StorefrontAPI.Blog, 'handle'> & {
        articles: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment RecommendedProduct on Product {\n    id\n    title\n    handle\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n  }\n  query OtherProducts($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 9, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...RecommendedProduct\n      }\n    }\n  }\n': {
    return: OtherProductsQuery;
    variables: OtherProductsQueryVariables;
  };
  '#graphql\n  query ProductPageBlogArticles($language: LanguageCode)\n    @inContext(language: $language) {\n    blogs(first: 1) {\n      nodes {\n        handle\n        articles(first: 3, sortKey: PUBLISHED_AT, reverse: true) {\n          nodes {\n            id\n            title\n            handle\n            image {\n              id\n              url\n              altText\n              width\n              height\n            }\n            blog {\n              handle\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: ProductPageBlogArticlesQuery;
    variables: ProductPageBlogArticlesQueryVariables;
  };
